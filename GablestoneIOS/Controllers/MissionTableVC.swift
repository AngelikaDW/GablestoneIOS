//
//  MissionTableVC.swift
//  GablestoneIOS
//
//  Created by AngelikaDW on 23/04/2018.
...
class MissionTableVC: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        tableView.register(UINib(nibName:"TourTableViewCell", bundle: nil), forCellReuseIdentifier: "Cell")
